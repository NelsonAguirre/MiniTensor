...
class TensorLike(Protocol):
    ...
    def to(
        self, device: Union[Device, str], dtype: Optional[DType] = None
    ) -> "TensorLike": ...
    ...
    @staticmethod
    def where(
        condition: "TensorLike", a: "TensorLike", b: "TensorLike"
    ) -> "TensorLike": ...
    @staticmethod
    ...
    def masked_fill(
        self: "TensorLike", mask: "TensorLike", value: float
    ) -> "TensorLike": ...
    def threshold(
        self: "TensorLike", threshold: float, value: float
    ) -> "TensorLike": ...
    ...
    # --- Reduction Ops ---
    def sum(
        self: "TensorLike", dim: Optional[Dim], keepdims: bool = False
    ) -> "TensorLike": ...
    def mean(
        self: "TensorLike", dim: Optional[Dim], keepdims: bool = False
    ) -> "TensorLike": ...
